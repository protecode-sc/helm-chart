...
### 2024.12.0
* Bump container to new 2024.12.0 versions.
* Switches postgresql container from bitnami/postgresql to docker.io/library/postgres image for long-term support.
